...
<jsp:useBean id="product" class="com.epam.servlets.entities.Dish" scope="request"/>
<html>
<head>
    <title>Order</title>
...
<%
    if (request.getAttribute("inf") != null && request.getAttribute("inf").equals("error")) {
        out.println("<div class=\"w3-panel w3-red w3-display-container w3-card-4 w3-round\">\n" +
                "   <span onclick=\"this.parentElement.style.display='none'\"\n" +
                "   class=\"w3-button w3-margin-right w3-display-right w3-round-large w3-hover-green w3-border w3-border-green w3-hover-border-grey\">×</span>\n" +
                "   <h5>The dish will not be ready at this time. Please select the time given the cooking time.</h5></div>");
    }
