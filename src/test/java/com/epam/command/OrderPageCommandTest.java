...
public class OrderPageCommandTest {
    ...
    @InjectMocks
    private static Command command = CommandEnum.getCurrentCommand("ORDERPAGE");
    ...
    @Test
    public void getProduct() throws DAOException, CommandException {
        command.execute(request);
        verify(menuDAO, atLeastOnce()).getProductForOrder(anyString());
    }
}
